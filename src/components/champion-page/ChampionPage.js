              ...
              <div className='champion-info__available-skins'>
                {!!currentChampion.skins &&
                  currentChampion.skins.map((el) => {
                    return (
                      <button
                        className={`champion-info__skin ${imageCounter ===
                          el.num && 'champion-info__skin_active'}`}
                  ...
                  <div className='champion-difficulty'>
                    <div className='champion-difficulty__box'>
                      <div className='champion-difficulty__graph-box'>
                        ...
                        <span
                          className={`champion-difficulty__graph ${currentDifficulty >=
                            4 && 'champion-difficulty__graph_active'}`}
                        />
                        <span
                          className={`champion-difficulty__graph ${currentDifficulty >=
                            8 && 'champion-difficulty__graph_active'}`}
                        />
                      </div>
